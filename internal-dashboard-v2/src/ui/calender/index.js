...
import { DayPickerRangeController, FocusedInputShape, ModifiersShape, isInclusivelyAfterDay } from "react-dates";
...
export default function Calendar(props) {
  const { startDate, endDate,  setEndDate,  setStartDate,  daySize,  numberOfMonths, orientation,  basePrice,  weekendPrice,  currencySymbol } = props;
  ...
  const focusInputDate = ( focusedInput ) => {
    setFocusedInput( focusedInput );
  };

  const renderDayContents = (e) => {
    let price = "";
