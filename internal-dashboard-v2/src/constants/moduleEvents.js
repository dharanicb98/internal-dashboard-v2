...
//     // module
//     MODULE_EVENT_RESERVATIONS: "RESERVATIONS",
//     MODULE_EVENT_USERS: "USERS",
//     MODULE_EVENT_LISTINGS: "LISTINGS",
//     MODULE_EVENT_PAYMENTS: "PAYMENTS",

//     //priority
//     MODULE_EVENT_PRIORITY_HIGH: "HIGH",
//     MODULE_EVENT_PRIORITY_MEDIUM: "MEDIUM",
//     MODULE_EVENT_PRIORITY_LOW: "LOW",

//     //action
//     MODULE_EVENT_ACTION_GET: "GET",
//     MODULE_EVENT_ACTION_POST: "POST",
//     MODULE_EVENT_ACTION_UPDATE: "UPDATE",
//     MODULE_EVENT_ACTION_DELETE: "DELETE",
//     MODULE_EVENT_ACTION_DECLINE: "DECLINE",
//     MODULE_EVENT_ACTION_CHECKIN: "CHECKIN",
//     MODULE_EVENT_ACTION_CHECKOUT: "CHECKOUT"
// }
...
export const CountryOptions = [
  ...
  { value: "Åland Island", name: "Åland Islands" },
  ...
  { value: "Bosnia an  Herzegovina", name: "Bosnia and Herzegovina" },
  { value: "Botswana",  name: "Botswana" },
  { value: "Bouvet Island", name: "Bouvet Island" },
  { value: "Brazil", name: "Brazil" }, 
  { value: "British Ind an Ocean Territory", name: "British Indian Ocean Territory" },
  { value: "Brunei Dar ssalam", name: "Brunei Darussalam" },
  ...
  { value: "Cayman Isla ds", name: "Cayman Islands" },
  { value: "Central A rican Republic", name: "Central African Republic" },
  { value: "Chad", name: "Chad" },
  { value: "Chile", name: "Chile" },
  { value: "China",  name: "China" },
  { value: "Christmas  sland", name: "Christmas Island" },
  { value: "Cocos (Ke ling) Islands", name: "Cocos (Keeling) Islands" },
  { value: "Colombia", name: "Colombia" },
  { value: "Comoros", name: "Comoros"  },
  { value: "Congo", name: "Congo" },
  { value: "Congo, The Democ atic Republic of The", name: "Congo, The Democratic Republic of The" },
  { value: "Cook Isla ds", name: "Cook Islands" },
  ...
  { value: "Czech Repu lic", name: "Czech Republic" },
  ...
  { value: "Taiwan (ROC)", name: "Taiwan (ROC)" },
