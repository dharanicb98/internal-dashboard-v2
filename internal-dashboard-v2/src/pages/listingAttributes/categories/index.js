...
import { createCategory, deleteCategory, getAllCategories, updateCategory } from "../../../services/categoriesServices";
...
const getNameIconComponent = (res) => (
  ...
  return (
    <div className="m-3">
      <PageHeader title="Categories" onClick={handleCreateOpen} />
      {rows && (
        <Table
          rows={rows}
