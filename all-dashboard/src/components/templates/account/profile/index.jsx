...
import FloatingDate from "../../../../ui/input/dateInput";
...
import {
  ...
  updateProfileData,
  getUserById,
} from "../../../../services/account/editProfile";
    ...
    try {
      if (file) {
        ...
        if (response.status === 200) {
          ...
          setPayload((prev) => {
            return { ...prev, user_avatar: profileImage?.file_path };
          });
          setUserData((prev) => {
            return { ...prev, user_avatar: profileImage?.file_path };
          });
  ...
  return (
    <>
      <div className="flex justify-between gap-[38px] relative md:hidden">
        <div className="flex-1 h-[65vh] overflow-y-auto min-w-[300px]">
          <div>
        ...
        <div className="md:hidden">
          ...
          <div className="flex p-4 gap-2 border border-grey shadow-base rounded-2xl mt-4">
            ...
            <div className="flex items-end mb-5 ">
              <div
                className="dui-radial-progress md-b: "
                style={{
                  "--value": 70,
                  "--size": "4.5rem",
                  "--thickness": "5px",
      ...
      <div className="hidden md:block  py-12 px-6">
        <MobileProfile
          userData={userData}
...
const Loader = ({ className }) => {
  return (
    <div
      className={`flex justify-center w-full h-full absolute md:top-[60%]  ${className}`}
      role="status"
    >
      <svg
        aria-hidden="true"
        class="w-28 h-28 text-gray-200 animate-spin dark:text-gray-600 fill-black"
        viewBox="0 0 100 101"
        fill="none"
