...
function MobileProfile({userData, showLoader, handleFileChange, handleSave, handleOnChangeInput}) {
  ...
  return showEditProfile ? (
    <EditProfileTab handleOnChangeInput={handleOnChangeInput} showEditProfile={setShowEditProfile} handleSave={handleSave}  userData={userData} showLoader={showLoader} handleFileChange={handleFileChange}/>
  ) : (
    <>
